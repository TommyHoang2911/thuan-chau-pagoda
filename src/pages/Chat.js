...
export default function Chat({ onNavigate }) {
    ...
    return (_jsxs("div", { className: "flex flex-col h-full", style: { background: '#f0f2f5' }, children: [_jsxs("div", { className: "flex-1 overflow-y-auto px-3 py-3 flex flex-col gap-2", style: { overscrollBehavior: 'contain' }, children: [_jsxs("div", { className: "flex items-center gap-2 my-1", children: [_jsx("div", { className: "flex-1 h-px bg-stone-200" }), _jsx("span", { className: "text-[10.5px] text-stone-400 px-2", children: new Date().toLocaleDateString('vi-VN', { weekday: 'long', day: 'numeric', month: 'long' }) }), _jsx("div", { className: "flex-1 h-px bg-stone-200" })] }), msgs.map((m, i) => (_jsxs("div", { className: `flex gap-2 ${m.role === 'user' ? 'justify-end' : 'items-end'}`, children: [m.role === 'bot' && (_jsx("img", { src: "/thuan-chau-pagoda/logo.png", alt: "", className: "w-7 h-7 rounded-full object-cover flex-shrink-0 self-end mb-0.5", style: { border: '1.5px solid #c8973a' } })), _jsxs("div", { className: `flex flex-col gap-0.5 ${m.role === 'user' ? 'items-end' : 'items-start'}`, style: { maxWidth: '78%' }, children: [m.card === 'welcome' && _jsx(WelcomeCard, {}), m.text && (_jsx("div", { className: `px-3 py-2 text-[14px] leading-relaxed whitespace-pre-line ${m.role === 'bot'
                                            ? 'rounded-2xl rounded-bl-sm bg-white text-stone-800 shadow-sm'
                                            : 'rounded-2xl rounded-br-sm text-white'}`, style: m.role === 'user' ? { background: '#1a4a2a' } : { border: '1px solid #ebebeb' }, children: m.text })), _jsx("span", { className: "text-[10px] text-stone-400 px-0.5", children: m.time })] })] }, i))), typing && (_jsxs("div", { className: "flex gap-2 items-end", children: [_jsx("img", { src: "/thuan-chau-pagoda/logo.png", alt: "", className: "w-7 h-7 rounded-full object-cover flex-shrink-0", style: { border: '1.5px solid #c8973a' } }), _jsx("div", { className: "bg-white rounded-2xl rounded-bl-sm px-4 py-3 shadow-sm flex gap-1.5 items-center", style: { border: '1px solid #ebebeb' }, children: [0, 1, 2].map(i => (_jsx("div", { className: "w-2 h-2 rounded-full bg-stone-300 animate-bounce", style: { animationDelay: `${i * 0.15}s` } }, i))) })] })), _jsx("div", { ref: bottomRef })] }), options.length > 0 && (_jsx("div", { className: "flex-shrink-0 bg-white", style: { borderTop: '1px solid #e8e8e8' }, children: _jsx("div", { className: "flex flex-wrap gap-2 px-3 py-2.5", children: options.map(o => (_jsx("button", { onClick: () => pick(o), className: "px-3.5 py-1.5 rounded-full text-[13px] font-medium transition active:scale-95", style: {
