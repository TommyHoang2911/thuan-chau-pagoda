...
export default function Chat({ onNavigate }) {
    ...
    return (_jsxs("div", { className: "flex flex-col h-full", children: [_jsxs("div", { className: "relative bg-gradient-to-br from-[#3d1a00] via-[#6b2d00] to-[#4a1500] text-center py-6 px-4 overflow-hidden flex-shrink-0", children: [_jsx("div", { className: "absolute inset-0 opacity-10", style: { backgroundImage: 'repeating-linear-gradient(45deg,transparent,transparent 24px,rgba(200,151,58,.4) 24px,rgba(200,151,58,.4) 26px)' } }), _jsx("h2", { className: "font-['Cormorant_Garamond'] text-[22px] font-bold text-amber-200 relative", children: "\uD83D\uDCAC H\u1ECFi \u0110\u00E1p" }), _jsx("div", { className: "w-16 h-px bg-gradient-to-r from-transparent via-amber-400 to-transparent mx-auto my-2.5" }), _jsx("p", { className: "text-[12px] text-amber-200/70 italic relative", children: "Tr\u1EE3 l\u00FD t\u1EF1 \u0111\u1ED9ng c\u1EE7a ch\u00F9a" })] }), _jsxs("div", { className: "flex-1 overflow-y-auto p-4 flex flex-col gap-3 bg-amber-50/40", children: [msgs.map((m, i) => (_jsxs("div", { className: `flex gap-2.5 ${m.role === 'user' ? 'justify-end' : 'items-end'}`, children: [m.role === 'bot' && (_jsx("div", { className: "w-7 h-7 rounded-full bg-gradient-to-br from-[#3d1a00] to-orange-700 flex items-center justify-center text-[13px] flex-shrink-0 mb-0.5", children: "\u2638" })), _jsxs("div", { className: `flex flex-col gap-1 max-w-[78%] ${m.role === 'user' ? 'items-end' : 'items-start'}`, children: [_jsx("div", { className: `px-3.5 py-2.5 rounded-2xl text-[13.5px] leading-relaxed whitespace-pre-line ${m.role === 'bot'
                                            ? 'bg-white text-stone-800 shadow-sm border border-amber-100 rounded-bl-sm'
                                            : 'bg-gradient-to-br from-[#6b2d00] to-[#3d1a00] text-amber-100 rounded-br-sm'}`, children: m.text }), _jsx("span", { className: "text-[10px] text-stone-400 px-1", children: m.time })] })] }, i))), typing && (_jsxs("div", { className: "flex gap-2.5 items-end", children: [_jsx("div", { className: "w-7 h-7 rounded-full bg-gradient-to-br from-[#3d1a00] to-orange-700 flex items-center justify-center text-[13px] flex-shrink-0", children: "\u2638" }), _jsx("div", { className: "bg-white px-4 py-3 rounded-2xl rounded-bl-sm shadow-sm border border-amber-100 flex gap-1.5 items-center", children: [0, 1, 2].map(i => (_jsx("div", { className: "w-2 h-2 rounded-full bg-stone-400 animate-bounce", style: { animationDelay: `${i * 0.15}s` } }, i))) })] })), _jsx("div", { ref: bottomRef })] }), options.length > 0 && (_jsx("div", { className: "flex flex-wrap gap-2 px-4 py-3 bg-white border-t border-amber-100 flex-shrink-0", children: options.map(o => (_jsx("button", { onClick: () => pick(o), className: "px-4 py-2 border-2 border-amber-300 bg-amber-50 text-[#3d1a00] rounded-full text-[12.5px] font-medium hover:bg-amber-100 active:scale-95 transition-all whitespace-nowrap", children: o }, o))) }))] }));
}
