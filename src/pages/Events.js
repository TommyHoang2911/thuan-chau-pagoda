...
export default function Events() {
    ...
    return (_jsxs("div", { children: [_jsxs("div", { className: "relative overflow-hidden", style: { background: '#1a4a2a' }, children: [_jsx("img", { src: "/thuan-chau-pagoda/banner.png", alt: "Ch\u00F9a Thu\u1EADn Ch\u00E2u", className: "w-full object-cover", style: { maxHeight: '180px', objectPosition: 'center' } }), _jsx("div", { className: "absolute inset-0", style: { background: 'linear-gradient(to top, rgba(26,74,42,0.7) 0%, transparent 60%)' } }), _jsxs("div", { className: "absolute bottom-0 left-0 right-0 text-center pb-3 px-4", children: [_jsx("div", { className: "w-16 h-px mx-auto mb-2", style: { background: 'linear-gradient(90deg,transparent,#c8973a,transparent)' } }), _jsx("p", { className: "text-[12px] italic", style: { color: 'rgba(232,201,122,0.85)' }, children: "L\u1ECBch l\u1EC5 h\u1ED9i, kh\u00F3a tu v\u00E0 ho\u1EA1t \u0111\u1ED9ng t\u1EA1i ch\u00F9a" })] })] }), _jsxs("div", { className: "mx-4 mt-4 bg-gradient-to-r from-[#3d1a00] to-[#6b2d00] rounded-2xl p-4 flex items-center gap-3 shadow-lg", children: [_jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "text-amber-200 text-[13.5px] font-semibold", children: "\uD83D\uDCF1 C\u00E0i app v\u1EC1 m\u00E0n h\u00ECnh ch\u00EDnh" }), _jsx("p", { className: "text-amber-200/65 text-[11.5px] mt-0.5", children: "Nh\u1EADn th\u00F4ng b\u00E1o s\u1EF1 ki\u1EC7n t\u1EE9c th\u00EC" })] }), _jsx("button", { className: "bg-amber-400 text-[#3d1a00] text-[12px] font-bold px-3 py-2 rounded-lg whitespace-nowrap hover:bg-amber-300 transition", children: "C\u00E0i \u0111\u1EB7t" })] }), _jsx("div", { className: "p-4 flex flex-col gap-4", children: loading
