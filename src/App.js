...
export default function App() {
    ...
    return (_jsxs("div", { className: "flex flex-col", style: { height: '100dvh', background: '#f0f2f5' }, children: [_jsx(Header, { onNotif: handleNotif, activeTab: tab }), _jsxs("main", { className: "flex-1 overflow-hidden relative", children: [_jsx("div", { className: `absolute inset-0 flex flex-col ${tab === 'chat' ? '' : 'hidden'}`, children: _jsx(Chat, { onNavigate: t => changeTab(t) }) }), _jsx("div", { id: "panel-events", className: `absolute inset-0 overflow-y-auto bg-[#f5f5f5] ${tab === 'events' ? '' : 'hidden'}`, style: { WebkitOverflowScrolling: 'touch' }, children: _jsx("div", { className: "pb-4 animate-[fadeUp_.2s_ease]", children: _jsx(Events, {}) }) }), _jsx("div", { id: "panel-causieu", className: `absolute inset-0 overflow-y-auto bg-[#f5f5f5] ${tab === 'causieu' ? '' : 'hidden'}`, style: { WebkitOverflowScrolling: 'touch' }, children: _jsx("div", { className: "pb-4 animate-[fadeUp_.2s_ease]", children: _jsx(CauSieu, {}) }) }), _jsx("div", { id: "panel-about", className: `absolute inset-0 overflow-y-auto bg-[#f5f5f5] ${tab === 'about' ? '' : 'hidden'}`, style: { WebkitOverflowScrolling: 'touch' }, children: _jsx("div", { className: "pb-4 animate-[fadeUp_.2s_ease]", children: _jsx(About, {}) }) })] }), _jsx(BottomNav, { active: tab, onChange: changeTab })] }));
}
